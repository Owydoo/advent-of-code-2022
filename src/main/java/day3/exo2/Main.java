...
import static day3.exo1.Main.getSumWithPriorities;

public class Main {
    public static void main(String[] args) {
//                String filename = "src/main/java/day3/inputs/input1.txt";
        String filename = "src/main/java/day3/inputs/input2.txt";
